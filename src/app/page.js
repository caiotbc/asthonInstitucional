      ...
      <div className={styles.container}>
          ...
          <div className={styles.heroContent}>
            <div className={styles.heroText}>
              ...
              <h2>
                ...
                <strong>IoT e LoRaWAN</strong> para coleta de dados em tempo
                real
              </h2>
            </div>
        ...
        <main>
          ...
          <section id="quem-somos" className={styles.quemSomos}>
            ...
            <div>
              ...
              <p>
                ...
                Gerais, especializada em fornecer soluções de conectividade, a
                fim de simplificar a vida dos usuários.
                <br />
                <br />
                Através de soluções avançadas, oferecemos serviços de
                monitoramento de parâmetros em tempo real, proporcionando um
                novo conceito de IoT ao mercado.
                <br />
                <br />
          ...
          <section id="produto" className={styles.produto}>
            ...
            <p>
              Nossa Estação de Monitoramento Hidrológico oferece dados precisos
              em tempo real. Os dados de nível e pluviosidade são coletados
              pelos sensores instalados e enviados para o dashboard online por
              meio do MARLIN (Módulo Coletor de Dados LoRaWAN).
            </p>
            <div>
          ...
          <section className={styles.Marlin}>
            ...
            <div>
              ...
              <p>
                ...
                monitorem a situação hidrológica de forma fácil e rápida. O
                MARLIN é a peça chave que permite a transmissão dos dados
                coletados para o dashboard. É possível garantir que os usuários
                recebam informações atualizadas em tempo real e alertas em
